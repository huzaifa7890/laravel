                         ...
                         <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($k['pprice']); ?></td>
                                            <td><?php echo e($k['sprice']); ?></td>
                                            <td><?php echo e($k['quantites']); ?></td>
                                            <td><img src="uploads/<?php echo e($k->image); ?>" width=50px></td>
                                            <td><a href="forcedel/<?php echo e($k->id); ?>" class="btn btn-warning waves-effect waves-float btn-sm waves-green">Permantaly Delete</a>
                                           <a href="restore/<?php echo e($k->id); ?>" class="btn btn-danger waves-effect waves-float btn-sm waves-red">Restore</a> </td>
...
</html><?php /**PATH C:\xampp\htdocs\jet\jetblog\resources\views/trash.blade.php ENDPATH**/ ?>