                ...
                <?php echo csrf_field(); ?>
                    ...
                    <div class="body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">                                
                                <span class="input-group-text"><?php if(Route::has('password.request')): ?>
                             <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('password.request')); ?>">
                              <?php endif; ?><i class="zmdi zmdi-lock"></i></a></span>
                            </div>                            
                        </div>
                        <div class="checkbox">
                        ...
                        <a href=" <?php echo e(__('Log in')); ?>" class="btn btn-primary btn-block waves-effect waves-light">SIGN IN</a>                        
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\jet\jetblog\resources\views/auth/login.blade.php ENDPATH**/ ?>